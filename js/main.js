...
const channels = [
    { id: 'hiE4kZvuSrk', name: 'APRENDA A DESENHAR DO ZERO - EXERCÍCIOS BÁSICOS E DICAS FÁCEIS DE DESENHO PARA INICIANTES' },
    { id: 'qtAM7DmkaAo', name: 'COMECE COM ESSAS TÉCNICAS PARA CHEGAR NESSE NÍVEL DE DESENHO - DICAS PARA EVOLUIR NO DESENHO' },
    { id: 'ISiFqPCu4Us', name: 'COMO DESENHAR FIGURA HUMANA - APRENDA A DESENHAR FIGURA HUMANA SEM MEDO' },
    { id: 'flgIFJdcjvM', name: 'COMO DESENHAR ANIMAIS | PASSO A PASSO COMPLETO + DICAS DE DESENHO' },
    { id: 'c8HL1TbudmM', name: 'COMO DESENHAR FLORES E PLANTAS SUPER FÁCIL | PASSO A PASSO' },
    { id: 'ntOwwg5ekKw', name: 'COMO DESENHAR CENÁRIOS - EXERCÍCIOS BÁSICOS, PERSPECTIVA E ENQUADRAMENTO FOTOGRÁFICO' },
    { id: 'NYG-umw9nT8', name: 'MATERIAIS DE DESENHO PARA COMEÇAR A DESENHAR DO ZERO + DICAS DE UTILIZAÇÃO E EXERCÍCIOS DE DESENHO' },
    { id: '0hxR2CyReVA', name: 'COMO ENCONTRAR SEU ESTILO DE DESENHO FAVORITO' }
 ];
